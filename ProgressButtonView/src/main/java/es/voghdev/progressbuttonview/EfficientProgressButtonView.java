...
class EfficientProgressButtonView extends ProgressButtonView {
    ...
    public EfficientProgressButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EfficientProgressButtonView(Context context, AttributeSet attrs, int defStyle) {
